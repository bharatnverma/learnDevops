    ...
    stages {
      ...
      stage('Deploy to Kubernetes') {
          ...
          steps{
              ...
              sh '''ssh -i "/home/bharat/Downloads/kubesetup.pem" ec2-user@ec2-3-110-190-236.ap-south-1.compute.amazonaws.com " curl -OJ https://github.com/bharatnverma/learnDevops/raw/main/deployment.yaml " 
                    ssh -i "/home/bharat/Downloads/kubesetup.pem" ec2-user@ec2-3-110-190-236.ap-south-1.compute.amazonaws.com " kubectl --kubeconfig ~/.kube/config  apply -f deployment.yaml " 
